function [hs A] = KorjaaTietokantoja(hs,A)


paikka = find(strcmp(hs.Nimi,'Elomaa Kike'));
hs.Nimi{paikka} = 'Elomaa Kike (Ritva)'; % sama kuin tuloksissa [YLE]
...
hs.Nimi{paikka} = 'Jokila Kirsi (Killi)'; % ei vastannut muutenkaan hs.
