...
St.stereoF = figure(2); set(St.stereoF,'name',St.title,'numbertitle','off','CloseRequestFcn',{@closeReqFcn,St});
...
St.azLeftButton = uicontrol(gcf,'string','Left','callback',{@changeAz,{St,10}},'position',[41 30 38 20]);
St.azRightButton = uicontrol(gcf,'string','Right','callback',{@changeAz,{St,-10}},'position',[81 30 38 20]);
St.azLeftRotButton = uicontrol(gcf,'string','<<','callback',{@rotateAz,{St,10}},'position',[41 10 38 20]);
St.azRightRotButton = uicontrol(gcf,'string','>>','callback',{@rotateAz,{St,-10}},'position',[81 10 38 20]);
St.elUpButton = uicontrol(gcf,'string','Up','callback',{@changeEl,{St,-5}},'position',[121 30 38 20]);
St.elDownButton = uicontrol(gcf,'string','Down','callback',{@changeEl,{St,5}},'position',[161 30 38 20]);
St.idcText = uicontrol(gcf,'style','text','string','IDC','position',[301 30 38 20]);
St.idcEdit = uicontrol(gcf,'style','edit','string','100','callback',{@changeIdc,St},'position',[291 10 58 20]);
St.changeModeList = uicontrol(gcf,'style','listbox','string',{'Parallel';'Crossed'},'callback',{@changeMode,St},'position',[201 10 78 40]);
St.rotButton = uicontrol(gcf,'string','Free Rotation','callback',{@freeRot,St},'position',[121 10 78 20]);
St.PrintViewsButton = uicontrol(gcf,'string','Print Views','callback',{@printViews,St},'position',[661 30 68 20]);
St.resetViewButton = uicontrol(gcf,'string','Reset View','callback',{@resetView,St},'position',[661 10 68 20]);
St.plotsMoreDistanceButton = uicontrol(gcf,'string','Plots <->','position',[581 30 68 20]);
St.plotsLessDistanceButton = uicontrol(gcf,'string','Plots >-<','position',[581 10 68 20]);
St.plotsMoreZoomButton = uicontrol(gcf,'string','Zoom +','position',[501 30 68 20]);
St.plotsLessZoomButton = uicontrol(gcf,'string','Zoom -','position',[501 10 68 20]);
